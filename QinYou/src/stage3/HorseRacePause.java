...
public class HorseRacePause {
    ...
    private HorseRace horseGame;
     public int getIndex() {
        return index;
    }
    public HorseRacePause(Graphics g,HorseRace horseGame) {
         try {
            this.g = g;
            index = 1;
        ...
        if (horseGame.getCurrentMusicState() == true) {
